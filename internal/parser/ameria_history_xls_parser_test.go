			...
			expectedResult: []model.Transaction{
				{
					...
					Source:               source,
					AccountCurrency:      "AMD",
					Amount:               model.MoneyWith2DecimalPlaces{Cents: 10010},
					OriginCurrency:       "",
				...
				},
				{
					...
					Source:               source,
					AccountCurrency:      "AMD",
					Amount:               model.MoneyWith2DecimalPlaces{Cents: 0},
					OriginCurrency:       "USD",
					OriginCurrencyAmount: model.MoneyWith2DecimalPlaces{Cents: 50010},
					FromAccount:          "1234567890123456",
					ToAccount:            "9999999999999999",
				},
				{
					...
					Amount:               model.MoneyWith2DecimalPlaces{Cents: 0},
					OriginCurrency:       "USD",
					OriginCurrencyAmount: model.MoneyWith2DecimalPlaces{Cents: 100000},
