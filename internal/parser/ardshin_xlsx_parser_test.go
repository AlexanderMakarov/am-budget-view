	...
	expected := []model.Transaction{
		{
			...
			IsExpense:            false,
			Amount:               model.MoneyWith2DecimalPlaces{Cents: 12300},
		...
		},
		{
			...
			IsExpense:            true,
			Amount:               model.MoneyWith2DecimalPlaces{Cents: 10800000},
		...
		},
		{
			Date:                 time.Date(2025, time.August, 14, 0, 0, 0, 0, time.UTC),
			IsExpense:            true,
			Amount:               model.MoneyWith2DecimalPlaces{Cents: 54000},
			FromAccount:          accountNumber,
			ToAccount:            "2470010211270000",
			Source:               source,
			AccountCurrency:      accountCurrency,
		...
		},
		{
			Date:                 time.Date(2025, time.August, 15, 0, 0, 0, 0, time.UTC),
			IsExpense:            true,
			Amount:               model.MoneyWith2DecimalPlaces{Cents: 500000},
			FromAccount:          accountNumber,
		...
		},
		{
			...
			IsExpense:            true,
			Amount:               model.MoneyWith2DecimalPlaces{Cents: 404910},
			FromAccount:          accountNumber,
			ToAccount:            "2470000348080010",
			Source:               source,
			AccountCurrency:      accountCurrency,
			OriginCurrency:       "USD",
			OriginCurrencyAmount: model.MoneyWith2DecimalPlaces{Cents: 1049},
		...
		},
		{
			...
			IsExpense:            true,
			Amount:               model.MoneyWith2DecimalPlaces{Cents: 681000},
			FromAccount:          accountNumber,
			ToAccount:            "2470010211270000",
			Source:               source,
			AccountCurrency:      accountCurrency,
