...
// FileInfo is a struct representing a file info with parsed transactions.
...
func (g GroupList) Less(i, j int) bool {
	return g[i].Total.Cents > g[j].Total.Cents
}
