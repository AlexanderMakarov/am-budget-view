...
func TestInecoExcelFileParserParseRawTransactionsFromFile(t *testing.T) {
	...
	sourceRegular := &model.TransactionsSource{
	...
	sourceCard := &model.TransactionsSource{
		TypeName:        "Inecobank XLSX statement",
			...
			expectedResult: []model.Transaction{
				{
					...
					AccountCurrency:      "AMD",
					Amount:               model.MoneyWith2DecimalPlaces{Cents: 400000},
					OriginCurrency:       "",
					OriginCurrencyAmount: model.MoneyWith2DecimalPlaces{Cents: 400000},
				...
				},
				{
					...
					Source:               sourceRegular,
					AccountCurrency:      "AMD",
					Amount:               model.MoneyWith2DecimalPlaces{Cents: 7800010},
					OriginCurrency:       "",
					OriginCurrencyAmount: model.MoneyWith2DecimalPlaces{Cents: 7800010},
			...
			expectedResult: []model.Transaction{
				{
					...
					Source:               sourceCard,
					AccountCurrency:      "AMD",
					Amount:               model.MoneyWith2DecimalPlaces{Cents: 35000},
					OriginCurrency:       "",
					OriginCurrencyAmount: model.MoneyWith2DecimalPlaces{Cents: 35000},
				...
				},
				{
					...
					Source:               sourceCard,
					AccountCurrency:      "AMD",
					Amount:               model.MoneyWith2DecimalPlaces{Cents: 784},
					OriginCurrency:       "USD",
					OriginCurrencyAmount: model.MoneyWith2DecimalPlaces{Cents: 2},
					FromAccount:          "1234567890121234",
					ToAccount:            "UnknownAccount",
				},
				{
					...
					Source:               sourceCard,
					AccountCurrency:      "AMD",
					Amount:               model.MoneyWith2DecimalPlaces{Cents: 99999999999},
					OriginCurrency:       "",
					OriginCurrencyAmount: model.MoneyWith2DecimalPlaces{Cents: 99999999999},
					FromAccount:          "UnknownAccount",
