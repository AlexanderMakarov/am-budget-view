	...
	expected := []model.Transaction{
		{
			...
			IsExpense:            true,
			Amount:               model.MoneyWith2DecimalPlaces{Cents: 300000}, // 3,000.00
			FromAccount:          accountNumber,
			ToAccount:            "",
			Source:               source,
			AccountCurrency:      accountCurrency,
			OriginCurrency:       "",
			OriginCurrencyAmount: model.MoneyWith2DecimalPlaces{Cents: 0},
			Details:              "Յուքոմ բջջ . պարտքի վճար /43210123/ (մոբայլ բանկինց 150123456)",
		},
		{
			Date:                 time.Date(2025, time.October, 1, 0, 0, 0, 0, time.UTC),
			IsExpense:            false,
			Amount:               model.MoneyWith2DecimalPlaces{Cents: 1230000}, // 12,300.00
			FromAccount:          "",
		...
		},
		{
			...
			IsExpense:            true,
			Amount:               model.MoneyWith2DecimalPlaces{Cents: 420000}, // 4,200.00
			FromAccount:          accountNumber,
			ToAccount:            "",
			Source:               source,
			AccountCurrency:      accountCurrency,
		...
		},
		{
			Date:                 time.Date(2025, time.October, 4, 0, 0, 0, 0, time.UTC),
			IsExpense:            true,
			Amount:               model.MoneyWith2DecimalPlaces{Cents: 170000}, // 1,700.00
			FromAccount:          accountNumber,
			ToAccount:            "",
			Source:               source,
			AccountCurrency:      accountCurrency,
		...
		},
		{
			Date:                 time.Date(2025, time.October, 4, 0, 0, 0, 0, time.UTC),
			IsExpense:            true,
			Amount:               model.MoneyWith2DecimalPlaces{Cents: 1100000}, // 11,000.00
			FromAccount:          accountNumber,
			ToAccount:            "",
			Source:               source,
			AccountCurrency:      accountCurrency,
		...
		},
		{
			Date:                 time.Date(2025, time.October, 4, 0, 0, 0, 0, time.UTC),
			IsExpense:            true,
			Amount:               model.MoneyWith2DecimalPlaces{Cents: 45000}, // 450.00
			FromAccount:          accountNumber,
			ToAccount:            "",
			Source:               source,
			AccountCurrency:      accountCurrency,
		...
		},
		{
			Date:                 time.Date(2025, time.October, 4, 0, 0, 0, 0, time.UTC),
			IsExpense:            false,
			Amount:               model.MoneyWith2DecimalPlaces{Cents: 440000}, // 4,400.00
			FromAccount:          "",
			ToAccount:            accountNumber,
			Source:               source,
			AccountCurrency:      accountCurrency,
